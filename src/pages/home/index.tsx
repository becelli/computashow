...
export default function Home({ authors }: { authors: Author[] }) {
  const translation = useTranslation();
  console.log(authors);
  ...
  return (
    <section className="bg-white">
      ...
      <footer className="flex flex-col items-center justify-center w-full h-24 border-t">{/* <Authors authors={authors} /> */}</footer>
    </section>
  );
}
